...
test('redactSecrets should redact various PAT patterns', () => {
  const input = 'My token is ghp_1234567890abcdefghijklmnopqrstuvwxyz and fine-grained is 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7';
...
test('redactAny should handle objects', () => {
  const obj = {
    ...
    nested: {
      secret: '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7'
    },
    safe: 123
  };
  const redacted = redactAny(obj) as any;
...
test('redactAny should handle arrays', () => {
  const arr = ['ghp_1234567890abcdefghijklmnopqrstuvwxyz', { key: 'ghp_1234567890abcdefghijklmnopqrstuvwxyz' }];
  const redacted = redactAny(arr) as any[];
